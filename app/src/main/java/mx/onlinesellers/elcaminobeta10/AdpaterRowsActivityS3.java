...
/**
 * Created by dis2 on 31/05/16.
 */
public class AdpaterRowsActivityS3 extends BaseAdapter {
    Context context;
    ...
    public AdpaterRowsActivityS3(Context context, Map<Integer, Map<String, Object>> data, Typeface typeface){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View vi = convertView;
        if (vi == null)
            vi = inflater.inflate(R.layout.row_activity_s3, parent, false);

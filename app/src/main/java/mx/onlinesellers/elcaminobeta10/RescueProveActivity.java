...
public class RescueProveActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rescue_prove);configureBar("Rescate", getResources().getString(R.string.ELCIcon_crane));
        configureBarMenu();
    }
    ...
    public void createActivityList(){
        ...
        Item02.put("t", "Rescate y Ayuda Moto");
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        intent.putExtra("t","Rescate");
        intent.putExtra("i",getResources().getString(R.string.ELCIcon_crane));

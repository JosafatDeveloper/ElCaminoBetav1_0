 ...
 */
public class AdpaterRowsActivityS1 extends BaseAdapter {
    Context context;
    ...
    public AdpaterRowsActivityS1(Context context, Map<Integer, Map<String, Object>> data, Typeface typeface){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View vi = convertView;
        if (vi == null)
            vi = inflater.inflate(R.layout.row_activity_s1, parent, false);

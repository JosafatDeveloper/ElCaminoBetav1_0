...
public class RoutesActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        configureBar("Destinos", getResources().getString(R.string.ELCIcon_routeab));
        configureBarMenu();
    ...
    public void createActivityList(){
        ...
        Item01.put("t", "Tepozotlan");
        Item01.put("m", "Pueblo Mágico");
        Item01.put("d", getResources().getString(R.string.ELCIcon_routeab));
        ...
        Item02.put("t", "Acapulco, Morelos");
        Item02.put("m", "Playa");
        Item02.put("d", getResources().getString(R.string.ELCIcon_routeab));
        Item02.put("p", "Centro");
        ...
        Item03.put("t", "Prismas basalticos");
        Item03.put("m", "Punto turistico");
        Item03.put("d", getResources().getString(R.string.ELCIcon_routeab));
        ...
        Item04.put("t", "Santuario de Aves");
        Item04.put("m", "Punto turistico");
        Item04.put("d", getResources().getString(R.string.ELCIcon_routeab));
        Item04.put("p", "Puebla");
        ...
        Typeface ElCaminoFontIcon = Typeface.createFromAsset(getAssets(), "fonts/ElCamnioFontIcon-Regular.ttf");
        //listViewActivity.setOnItemClickListener(this);
        listViewActivity.setAdapter(new AdpaterRowsActivityS5(this, listAdapterActivity, ElCaminoFontIcon));
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        intent.putExtra("t", (String)listAdapterActivity.get(position).get("t"));
        intent.putExtra("i",getResources().getString(R.string.ELCIcon_routeab));
